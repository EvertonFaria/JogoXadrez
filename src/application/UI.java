...
public class UI {
	...
	public static PosicaoXadrez LerPosicaoXadrex(Scanner sc) {
		try {
			...
			throw new InputMismatchException("Erro obtendo posição de Xadrez. Posições válidas vão de A1 até H8!");
		}
	}
	...
	public static void imprimePeca(PecaXadrez peca, boolean fundoPeca) {
		if (fundoPeca) {
